...
public class UserInteraction {
	...
	//ADDING EMPLOYEE
	public static boolean AddEmployee() throws ClassNotFoundException, SQLException
	{
	...
	public static void  ModifyEmployee() throws ClassNotFoundException, SQLException
	{
		HashMap<Integer,Object> hmap= new HashMap<Integer,Object>();
		 ...
		 */
		 ...
		 case 8:System.out.println("Select the Department number");
			 	int Department_id=s.nextInt();
			 	if(Validate.validateDepartment_id(Department_id))
				{hmap.put(8,Department_id);
				System.out.println("select the project number");
				...
				case 1:
					...
					System.out.println("Invalid Project No.");
					break;
				case 2:
					System.out.println("52- scala    53-html");
					Project_id=s.nextInt();
					...
					System.out.println("Enter the valid Department Number");break;
		 default:
			 	System.out.println("Invalid Input");break;
		 	}
	
		EmployeeServiceImpl empsvc=new EmployeeServiceImpl();
		empsvc.ModifyEmployee(hmap);
	}

	public static void RemoveEmployee() throws ClassNotFoundException, SQLException
	{
	...
	public static void GetAllEmployee() throws ClassNotFoundException, SQLException{
