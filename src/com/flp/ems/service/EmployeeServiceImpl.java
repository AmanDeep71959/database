...
public class EmployeeServiceImpl implements IEmployeeService{
	...
	public void ModifyEmployee(HashMap<Integer,Object> hmap) throws ClassNotFoundException, SQLException {
		 ...
		 if(hsetKin_id.contains(hmap.get(2)))
			{
			emp=new Employee();
			emp.setKin_id((String)hmap.get(2));
			
		// Iterator itr=hmap.entrySet().iterator();
		 switch((Integer)hmap.get(0))
			{
				case 1:emp.setName((String)hmap.get(1));break;
				case 3:emp.setEmail_id((String)hmap.get(3));break;
				case 4:emp.setPhone_no((String)hmap.get(4));break;
				case 5:emp.setDate_of_birth((String)hmap.get(5));break;
				case 6:emp.setDate_of_Joining((String)hmap.get(6));break;
				case 7:emp.setAddress((String)hmap.get(7));break;
			}
			}
		else
	...
	@Override
	public void RemoveEmployee(String Kin_id) throws ClassNotFoundException, SQLException {
		// TODO Auto-generated method stub
		if(hsetKin_id.contains(Kin_id)){
			hsetKin_id.remove(Kin_id);
	...
	@Override
	public void SearchEmployee(String search) throws ClassNotFoundException, SQLException {
		// TODO Auto-generated method stub
		EmployeeDaoImplForList empdaolist=new EmployeeDaoImplForList();
